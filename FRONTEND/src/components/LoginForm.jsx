      ...
      <div className={`relative z-10 sm:mx-auto sm:w-full sm:max-w-md transition-all duration-1000 ${
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Sign in to your <span className="text-blue-600 dark:text-blue-400 font-semibold">ShrinkLink</span> account
          </p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm py-8 px-6 shadow-2xl rounded-2xl border border-white/20 dark:border-gray-700/20">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-3 rounded-xl animate-slide-in-left">
                <div className="flex items-center">
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center">
                    ...
                    <span>Sign In to ShrinkLink</span>
                  </div>
                )}
              </button>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button
                type="button"
                onClick={() => state(false)}
                className="w-full flex justify-center py-3 px-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-sm font-semibold text-gray-700 dark:text-gray-300 bg-white/50 dark:bg-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-blue-400 dark:hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all duration-300 hover:scale-105"
              >
